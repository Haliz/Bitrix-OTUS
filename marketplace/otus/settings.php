<?php
define('C_REST_CLIENT_ID','local.65bbea7f7d1593.19189323');//Application ID
define('C_REST_CLIENT_SECRET','PLYe524E73BX5jVKQBCowZCah30GEyWRtAe3vWhg1BtWpnj8ww');//Application key
// or
